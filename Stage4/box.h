    ...
    */
    float intersectSideways(Box& other)
    {
        ...
        if (m_pos_x > other.m_pos_x)
            return std::max<float>(0.0f, other.m_pos_x + (other.m_width / 1.93f) - m_pos_x + (m_width / 1.93f));
        else
            return std::min<float>(0.0f, other.m_pos_x - (other.m_width / 1.93f) - m_pos_x - (m_width / 1.93f));
    }
